...
public class DomainTest extends TestBasicObjects {

    @Test
    public void test_rasgos() {
        Assertions.assertEquals("Desarrollo en Java", jorge.getRasgos().get(0).getDescripcion());
    }

    @Test
    public void test_reaccionar() {
    ...
    @Test
    public void test_rasgo_reaccionar_varias_veces() {
        for (int i = 0; i < 5; i++) {
            jorge.getRasgos().get(0).serReaccionado(reaccionDeJorge);
        }
    ...
    @Test
    public void test_rasgo_reaccionar_y_cambiar_reaccion() {
        jorge.getRasgos().get(0).serReaccionado(reaccionDeJorge);
    ...
    @Test
    public void test_rasgo_reaccionar_y_sacar_reaccion() {
        jorge.getRasgos().get(0).serReaccionado(reaccionDeJorge);
    ...
    @Test
    public void test_rasgo_validable_puntuar() {
    ...
    @Test
    public void test_rasgo_validable_puntuar_y_sacar_puntuacion() {
        tobias.getRasgosValidables().get(0).getExpertise().serPuntuado(puntuacion);
    ...
    @Test
    public void test_rasgo_validable_puntuar_varias_veces() {
        for (int i = 0; i < 5; i++)
            tobias.getRasgosValidables().get(0).getExpertise().serPuntuado(puntuacion);
    ...
    @Test
    public void test_comentar_puntuacion() {
        tobias.getRasgosValidables().get(0).getExpertise().serPuntuado(puntuacion);
